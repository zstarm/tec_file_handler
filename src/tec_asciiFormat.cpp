...
namespace tec {
	...
	bool asciiFormatter::format_header(std::string &line, const char* delim, const char* separator) {
	...
	bool asciiFormatter::format_subzoneHeader(std::string &line, const char* delim, const char* separator) {
	...
	bool asciiFormatter::check_orphan_var(std::string &line, const char* delim) {
		std::string tmp;
	...
	bool asciiFormatter::check_invalidLine(std::string &line) {
